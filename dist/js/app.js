 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".hero-home__slider")) new core(".hero-home__slider", {
            ...
            if (document.querySelector(".reviews-home__slider")) new core(".reviews-home__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".reklama-services__slider")) new core(".reklama-services__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".employees-about__slider")) new core(".employees-about__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".services-home_about .services-home__body")) new core(".services-home_about .services-home__body", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (reviewsSliders.length) reviewsSliders.forEach(((reviewsSlider, index) => {
                let centeredSlides = "1" === reviewsSlider.dataset.centeredSlides ? true : false;
                new core(reviewsSlider, {
...
***************************************************************************** */
        ...
        var i, a, u, c, l = "undefined" == typeof navigator ? void 0 : navigator, d = null == l ? void 0 : l.clipboard, f = (null === (i = null == d ? void 0 : d.read) || void 0 === i || i.bind(d), 
        null === (a = null == d ? void 0 : d.readText) || void 0 === a || a.bind(d), null === (u = null == d ? void 0 : d.write) || void 0 === u || u.bind(d), 
        null === (c = null == d ? void 0 : d.writeText) || void 0 === c ? void 0 : c.bind(d)), p = "undefined" == typeof window ? void 0 : window, v = (null == p || p.ClipboardItem, 
        p);
        function b() {
        ...
        function h(e, t, n) {
            for (var o in r("listener called"), e.success = !0, t) {
                var i = t[o], a = n.clipboardData;
                a.setData(o, i), "text/plain" === o && a.getData(o) !== i && (r("setting text/plain failed"), 
                e.success = !1);
            }
            n.preventDefault();
        }
        function w(e) {
            var t = new m, n = h.bind(this, t, e);
        ...
        function D(n) {
            return e(this, void 0, void 0, (function() {
                ...
                return t(this, (function(t) {
                    ...
                    var o;
                    return w(n) ? (r("regular execCopy worked"), [ 2, !0 ]) : navigator.userAgent.indexOf("Edge") > -1 ? (r('UA "Edge" => assuming success'), 
                    [ 2, !0 ]) : g(document.body, n) ? (r("copyUsingTempSelection worked"), [ 2, !0 ]) : function(e) {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (ontopBtn) {
                let scroll = 0 !== parseInt(ontopBtn.dataset.ontop) && !isNaN(parseInt(ontopBtn.dataset.ontop)) ? ontopBtn.dataset.ontop : 250;
                window.addEventListener("scroll", (() => {
                    if (window.pageYOffset >= scroll) ontopBtn.classList.add("_active"); else ontopBtn.classList.remove("_active");
                }));
            }
            const homeVideo = document.querySelector(".video-howworkHome");
            if (homeVideo) homeVideoActions(homeVideo);
            ...
            if (copyLinks.length) copyLinks.forEach((copyLink => {
        ...
        function homeVideoActions(homeVideo) {
            ...
            if (homeVideoPlay) homeVideoPlay.addEventListener("click", (() => {
                homeVideoPoster.style = "opacity: 0;";
                setTimeout((() => {
                    homeVideoPoster.remove();
                    if (homeVideoVideo) homeVideoVideo.play();
                    if (homeVideoFrame) {
        ...
        function tariffsHomeActions(tariffsHome) {
            ...
            tariffHomeBodies.forEach((tariffHomeBody => {
                if (tariffHomeBody.classList.contains("spollers-tariffsHome__bg")) tariffHomeBody.addEventListener("click", (() => {
                    tariffHomeBodies.forEach((tariffHomeBody => {
                        let tariffHomeBodyAttr = tariffHomeBody.getAttribute("data-tariff");
        ...
        function regionModalActions(regionModal) {
            async function getRegions() {
                ...
                if (response.ok) {
                    ...
                    if (document.querySelector(".regionPopup")) renderRegions(result.root.row, regionModal);
            ...
            function renderRegions(result, regionModal) {
                ...
                result.forEach((e => {
                    ...
                    citiesPopupBody.forEach((i => {
                        if (i.textContent.toUpperCase() === region[0].toUpperCase()) i.nextElementSibling.insertAdjacentHTML("beforeend", `\n            <a href="#" data-center="${lat},${lon}" class="cityPopup__city">${city}</a>\n          `);
                    }));
                }));
            }
            const regionInput = document.querySelector(".content-regionPopup__input");
            if (regionInput) regionInput.addEventListener("input", (() => {
                if (regionInput.value.trim()) {
                    ...
                    cityCities.forEach((e => {
                        if (e.textContent.toLowerCase().indexOf(regionInput.value.toLowerCase()) >= 0) e.hidden = false; else e.hidden = true;
                    }));
                    ...
                    cityPopupBodies.forEach((cityPopupBody => {
                        ...
                        if (links.length === linksHid.length) cityPopupBody.hidden = true; else cityPopupBody.hidden = false;
                    }));
                } else {
            ...
            function regionModalLettersCheck(regionModal) {
                ...
                const cityPopupBodies = regionModal.querySelectorAll(".section-regionPopup");
                if (checkLetter) cityPopupBodies.forEach((cityPopupBody => {
                    if (cityPopupBody.querySelector(".section-regionPopup__title").textContent.trim().toUpperCase() === checkLetter.dataset.letter) cityPopupBody.hidden = false; else cityPopupBody.hidden = true;
                })); else cityPopupBodies.forEach((cityPopupBody => {
        ...
        function directionsActions(directions) {
            ...
            if (tariffNames.length && tariffPrices.length) document.addEventListener("click", (e => {
                const target = e.target;
                if (target.hasAttribute("data-tariff-price") || target.closest("[data-tariff-price]")) target.closest("[data-tariff-price]").classList.toggle("_active");
                if (target.hasAttribute("data-tariff-name") || target.closest("[data-tariff-name]")) {
                    ...
                    } else tariffPrices.forEach((tariffPrice => {
                        tariffName.classList.remove("_checked");
                        tariffPrice.classList.remove("_active");
                    }));
                }
